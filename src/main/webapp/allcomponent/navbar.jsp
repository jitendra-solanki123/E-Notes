...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<!--  Show Notes item -->
			<li class="nav-item"><a class="nav-link enabled" href="showNotes.jsp"><i
		...
		<a href="Login.jsp" class="btn btn-light my-2 my-sm-0 mr-2" data-toggle="modal" data-target="#exampleModal"
